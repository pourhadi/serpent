...
class ActionLoggerWrapper(wrappers.PyEnvironmentBaseWrapper):
...
#         train_env = T4TFEnv(metrics_key=dir_key)
        eval_env = suite_atari.load(env_name)
        train_env = ActionLoggerWrapper(env=suite_atari.load(env_name))
        ...
        actor_net = actor_distribution_network.ActorDistributionNetwork(
            ...
            conv_layer_params=[(8, (3, 3), 1)],

            # lstm_size=(40,),
            continuous_projection_net=normal_projection_net)
        critic_net = critic_network.CriticNetwork(
            (observation_spec, action_spec),
            observation_conv_layer_params=[(8, (3, 3), 1)],
            # observation_conv_layer_params=((32, (8, 8), 4), (64, (4, 4), 2), (64, (3, 3), 1)),
            # lstm_size=(40,),
        ...
        for _ in range(num_iterations):
            ...
            if global_step.numpy() % log_interval == 0:
                ...
                print(obs_shape)
                tf.compat.v2.summary.image(name='input_image', data=np.reshape(time_step.observation, (1, obs_shape[1], obs_shape[2], obs_shape[3])), step=global_step)
                timed_at_step = global_step.numpy()
                time_acc = 0
